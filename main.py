...
if __name__ == '__main__':
    pl.utilities.seed.seed_everything(seed=301023, workers=True)
    ...
    datamodule = GSVCitiesDataModule(
        ...
        val_set_names=['nordland', 'sped'], # pitts30k_val, pitts30k_test, msls_val
    )
    ...
    model = VPRModel(
        ...
        #---- Train hyperparameters
        lr=0.03, # 0.0002 for adam, 0.05 or sgd (needs to change according to batch size)
    ...
    checkpoint_cb = ModelCheckpoint(
        ...
        '_epoch({epoch:02d})_step({step:04d})_R1[{nordland/R1:.4f}]_R5[{nordland/R5:.4f}]',
